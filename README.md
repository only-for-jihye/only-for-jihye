...
### Career
- 2024.08 ~ 현재     : 오토앤(주) ICT연구소 IT관리팀 (직급 : 책임)
- 2018.10 ~ 2024.08 : (주)아이비컴텍 프로젝트팀 (직급 : 과장)

### Project
- 2024.12 ~ 2024.03 : 오토앤(주) 라오스IT 유지보수 업무이관 프로젝트 (담당 업무 : 총괄 Project Manager)
- 2024.10 ~ 현재     : 오토앤(주) ITSM 구축 프로젝트 (담당 업무 : 총괄 Project Manager)
- 2024.08 ~ 현재     : 오토앤(주) E-Commerce 채널 및 관리 시스템 운영 (담당 업무 : 시스템 운영 관리자 및 Database Administrator)
- 2018.10 ~ 2024.08 : SKTelecom TANGO 운용 수집관리 운영팀 (담당업무 : 수집관리 운영자)
- 2022.03 ~ 2024.08 : SKTelecom TANGO 클라우드 전환 사업 (담당업무 : 백엔드 개발자 및 클라우드 엔지니어)
